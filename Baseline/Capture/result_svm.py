...
if __name__ == '__main__':
    ...
    #     'class_weight':[{0:7,1:1.83}],
    # }
    # svr = svm.SVC()
    # clf = GridSearchCV(svr, params, scoring='f1')
    # clf.fit(X_train, Y_train)
    # # print(clf.best_params_)
    # # 加载最优参数
    # classifier = svm.SVC(**clf.best_params_)  # 加载最优参数
    ...
    # 使用svm算法 (linear-0.5696143430759175, rbf-0.45097522403795465, sigmod-0)
